  ...
  return (
    <article className="privacy-page container">
        ...
        <div className="privacy-page__section-body">
          <div className="privacy-page__status-prose" data-analytics-state={isEnabled ? 'enabled' : 'disabled'}>
            {isEnabled ? (
              ...
              <p>
                <strong>Analytics are disabled for this build.</strong> No tracker script is loaded, no pageview is
                sent, and no custom event is sent.
              </p>
            )}
          </div>
        </div>
      ...
      <section className="privacy-page__section" aria-labelledby="collection-heading">
        ...
        <div className="privacy-page__section-body">
          <div className="privacy-page__collection-grid">
            <div className="privacy-page__collection-column">
              <h3 className="privacy-page__subsection-title">Collected when enabled</h3>
              ...
              <ul className="privacy-page__list">
                ...
                <li>
                  Approved categorical interaction events, including standard theme mode and preset IDs. Custom
                  user-authored theme values are not collected.
                </li>
              </ul>
            </div>
      ...
      <section className="privacy-page__section" aria-labelledby="dnt-heading">
        ...
        <div className="privacy-page__section-body">
          <p>
            In an enabled build, the tracker script may load when Do Not Track is enabled, but no pageview or custom
            event is sent. A disabled build sends nothing.
          </p>
        </div>
      </section>
      ...
      <section className="privacy-page__section" aria-labelledby="events-heading">
        ...
        <div className="privacy-page__section-body">
          <p>
            This is the complete inventory of approved categorical interaction events. No other custom event families
            are collected.
          </p>
      ...
      <section className="privacy-page__section" aria-labelledby="operator-heading">
        ...
        <div className="privacy-page__section-body">
          <p>
            ...
            . Infrastructure is controlled by Marcus R. Brown. No third-party analytics processor is used, and data is
            not shared or sold.
          </p>
          <p>
